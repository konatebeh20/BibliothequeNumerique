            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    @if (session('success'))
                        <div class="alert alert-primary text-light text-center m-2" role="alert">
                            {{session('success')}}
                        </div>
                    @endif
                  ...
                  <form action="{{route('login')}}" method="POST" class="row g-3 needs-validation" novalidate >
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Avez-vous un compte? <a href="{{route('register')}}">Créer un compte</a></p>
                    </div>
                  </form>
              ...
              <div class="credits">
                ...
                Designed by <a href="https://bootstrapmade.com/">Edmundo</a>
              </div>
