        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <img src="/imgs/{{auth()->user()->image}}" alt="Profile" class="rounded-circle">
              <h2>{{auth()->user()->nom}}</h2>
              <h3>{{auth()->user()->prnom}}</h3>
            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <p class="small fst-italic">Personne, groupe qui fait usage de quelque chose, qui utilise un appareil, un service ...</p>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">{{auth()->user()->fonction}}</div>
                  </div>
