            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form   method="POST" action="{{route('register')}}"  enctype="multipart/form-data" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" name="fonction" class="form-control" id="yourName" required>
                      </div>
                    ...
                    <div class="col-12">
                        ...
                        <input type="file" name="image" class="form-control" id="yourPassword" required>
                    </div>
